<?php
require 'send_email6.php'; // Incluye el archivo de correo
...
// Consultar las últimas mediciones (3 horas) solo para el sensor con id 6
$query = "SELECT sensor_id, temperatura, humedad, timestamp 
          FROM sensores 
          WHERE sensor_id = 6 AND timestamp >= NOW() - INTERVAL 3 HOUR 
...
while ($row = $result->fetch_assoc()) {
    ...
    // Llamar a la función de alerta si la temperatura está fuera de rango
    sendTemperatureAlert($row["temperatura"]);
}
